...
module modVirtualNetworks 'br/public:avm/res/network/virtual-network:0.10.1' = [
...
module modpublicIpAddresses 'br/public:avm/res/network/public-ip-address:0.13.0' = [for pip in publicIpAddresses: {
...
module modVirtualNetworkGateways 'br/public:avm/res/network/virtual-network-gateway:0.12.0' = [
